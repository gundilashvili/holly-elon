    ...
    <footer className="footer-area footer-area--two pt-60">
      <div className="hl-container">
          ...
          <div className="col-lg-5 text-lg-start text-center">
            <div className="footer-widget">
              <ul className="footer-widget--list d-inline-block lh-1">
                <li className="footer-widget--item inline-style d-inline-block mb-md-0 mb-2">
        ...
        <div className="row footer-bottom">
          <div className="col-sm-6 text-center text-sm-start order-4 order-sm-0">
            <p className="mb-0">© Holly 2025, All rights reserved.</p>
          </div>
          <div className="col-sm-6 footer-widget text-center text-sm-end">
            <ul className="footer-widget--list">
              <li className="footer-widget--item d-inline-block me-4">
                <Link href="privacy-policy" className="footer-widget--link">
                  Privacy Policy
                </Link>
              </li>
