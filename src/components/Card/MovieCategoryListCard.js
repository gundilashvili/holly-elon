...
export default function MovieCategoryListCard({ movie }) {
  ...
  const getEmbedUrl = (_url) => {
    const embedBase = _url.replace("watch?v=", "embed/");
    return embedBase.includes("?") ? `${embedBase}&autoplay=1` : `${embedBase}?autoplay=1`;
  };
  return (
    ...
    <div className="category-list--item row">
      <div className="col-lg-4 mb-4 mb-lg-0">
        <div className="thumb me-3">
          <Image src={movie.image} alt="card-img" style={{ width: 400, height: 250 }} />
        </div>
      </div>
            ...
            >
              ...
              >
                <iframe
                  width="100%"
                  height="500"
                  src={getEmbedUrl(movie.videoSrc)}
